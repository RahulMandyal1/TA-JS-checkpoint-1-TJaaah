...
// for loop - for loop is one of  the easiest loop  and easy to declare  . you can initialize ,  give a condition  to 
// stop  and declare the variable only in one line .
// Example :
for (let i = 1 ; i<= 10 ;i++){
    console.log(i);
}
...
// While loop : In  while loop   the condition is tested first  and  then  the loop is  initalized if you  want to put restriction first
// then you can  use while loop 
